...
function SignUp() {
  ...
  const postData = () => {
    ...
    if(!emailRegex.test(email)){
      ...
      notifyA("Passeord must be contain at least 8 characters, including at least 1 number and 1 includes both lower and uppercase letters and special characters for example #,?,!")
      return
    }
  ...
  return (
    <div className="signUp">
      <div className="form-container">
        <div className="form">
          <img className="signUpLogo" src="https://1000logos.net/wp-content/uploads/2017/02/Logo-Instagram-1.png" alt=""/>
